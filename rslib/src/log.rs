...
#[cfg(not(all(target_family = "wasm", target_os = "unknown")))]
pub use native::set_global_logger;

/// Browsers do not have Anki's rotating native log files. Keep the public API
/// intact; browser diagnostics are handled by the JS/WASM host console.
#[cfg(all(target_family = "wasm", target_os = "unknown"))]
pub fn set_global_logger(_path: Option<&str>) -> Result<()> {
    Ok(())
}
